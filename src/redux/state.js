...
let store = {
    _state: {
        profilePage: {
            posts: [
                {id: 1, message: 'Hi,Victor', likesCount: "23"},
            ],
            newPostText: ''
        },
        dialogsPage: {
            messages: [
                {id: 1, message: 'Say Hi to Victor!'},
            ],
            dialogs: [
                {
                    id: 1,
                    name: 'Victor',
                    img: <img src="https://i.pinimg.com/474x/59/95/18/5995186a3da28eef8906f5d3878c76c2.jpg" alt="🐑"/>
                },
                {
                    id: 2,
                    name: 'Adam',
